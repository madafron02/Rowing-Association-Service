...
class TrainingTest {
    ...
    void defaultConstructorTest() {
        Training a = new Training(testEmail, 1, 0, 8, 10,
                0, LocalDateTime.of(2042, 12, 12, 20, 15),
                LocalDateTime.MAX, "8+");
    ...
    void checkIfValidTrueTest() {
        Training a = new Training(testEmail, 1, 0, 8, 10, 0,
    ...
    void checkIfValidOwnerIdNullTest() {
        Training a = new Training(null, 1, 0, 8, 10, 0,
                LocalDateTime.of(2042, 12, 12, 20, 15),
                LocalDateTime.MAX, "8+");
    ...
    void checkIfValidInvalidCertificateTest() {
        Training a = new Training(testEmail, 0, 0, 0, 0, 0,
                LocalDateTime.of(2042, 12, 12, 20, 15),
    ...
    void equalsFalseTest() {
        Training a = new Training(testEmail, 1, 0, 8, 10, 0,
                LocalDateTime.of(2022, 12, 12, 20, 15),
                LocalDateTime.of(2022, 12, 12, 20, 20), "8+");
        Training b = new Training("different@gmail.com", 1, 0, 8, 10, 0,
                LocalDateTime.of(2022, 12, 12, 20, 15),
                LocalDateTime.of(2022, 12, 12, 20, 20), "8+");
    ...
    void hashCodeTestEqual() {
        Training a = new Training(testEmail, 1, 0, 8, 10, 0,
                LocalDateTime.of(2022, 12, 12, 20, 15),
                LocalDateTime.of(2022, 12, 12, 20, 20), "8+");
        Training b = new Training(testEmail, 1, 0, 8, 10, 0,
                LocalDateTime.of(2022, 12, 12, 20, 15),
                LocalDateTime.of(2022, 12, 12, 20, 20), "8+");
